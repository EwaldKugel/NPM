...
% \textbf{Smart Government}\\
% 
% innen und außen direkte Verbesserungen
% 
% Ziel: Digitalisierung der Verwaltung (effizienter, effektiver), Vereinfachung der Kommunikation mit Bürger
% 
% Prozessoptimierung als Nebenziel, Transparenz durch Open Government Ansätze
% 
% \begin{itemize}
%   \item Einsatz von Informationstechnologie
%   \item Papiervorgänge digitalisieren (dabei optimieren, nicht 1:1)
%   \item automatisierte Verfahren (Teilschritte)
%   \item Einsatz von KI zur Entlastung der Mitarbeiter bei Routineaufgaben
% \end{itemize}
